...
export default function Portfolio() {
    return (
        ...
        <h1 className="text-center text-5xl font-semibold italic py-12">PORTFOLIO</h1>
        <p className="text-center text-3xl font-thin text-greytext">notes, details, reflections of</p>
        <p className="text-center text-3xl font-thin text-greytext">works, learnings, projects I have done</p>
