...
function usePopover(originalProps) {
  ...
  (0, import_react2.useImperativeHandle)(
    ref,
    () => (0, import_react_utils.createDOMRef)(popoverRef)
  );
  ...
  (0, import_utils2.useLayoutEffect)(() => {
    if (state.isOpen && popoverRef.current) {
      return (0, import_overlays3.ariaHideOutside)([popoverRef.current]);
    }
...
var PopoverTrigger = (0, import_system3.forwardRef)((props, _) => {
  ...
  const { onPress, ...rest } = (0, import_react4.useMemo)(() => {
  ...
  const hasNextUIButton = (0, import_react4.useMemo)(() => {
    return (triggerChildren == null ? void 0 : triggerChildren[0]) !== void 0;
  }, [triggerChildren]);
  return (0, import_react4.cloneElement)(child, (0, import_utils3.mergeProps)(rest, hasNextUIButton ? { onPress } : buttonProps));
});
...
var PopoverContent = (0, import_system4.forwardRef)((props, _) => {
  ...
  const { dialogProps, titleProps } = (0, import_dialog.useDialog)(
    {
      role
    },
    dialogRef
  );
  const arrowContent = (0, import_react5.useMemo)(() => {
    if (!showArrow)
      return null;
  ...
  const content = /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Component, { ...getDialogProps((0, import_utils4.mergeProps)(dialogProps, otherProps)), ref: dialogRef, children: [
