...
import { SelectionBehavior, DisabledBehavior } from '@react-types/shared';
...
type UseTableProps<T = object> = Props & TableStateProps<T> & AriaTableProps<T> & TableVariantProps;
